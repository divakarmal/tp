...
public class JsonSerializableAddressBookTest {
    ...
    private static final Path TYPICAL_PATIENT_FILE = TEST_DATA_FOLDER.resolve("typicalPatientAddressBook.json");
    ...
    public void toModelType_typicalPatientsFile_success() throws Exception {
        JsonSerializableAddressBook dataFromFile = JsonUtil.readJsonFile(TYPICAL_PATIENT_FILE,
                JsonSerializableAddressBook.class).get();
        AddressBook addressBookFromFile = dataFromFile.toModelType();
        AddressBook typicalPatientsAddressBook = TypicalPatient.getTypicalAddressBook();
